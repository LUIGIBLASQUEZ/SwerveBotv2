...
import frc.robot.commands.testcommands.DriveFire;
import frc.robot.commands.testcommands.driveturndrive;
...
// 6, 5.5, 6
    ...
    m_chooser.addOption("LimeTrack vS", (Command) new rotateToTarget(m_robotDrive, m_lime, m_output).andThen(new WaitCommand(1.5)).andThen(m_output.stopRun()));
    m_chooser.addOption("DriveFire", (Command) new DriveFire(m_robotDrive, m_output));
